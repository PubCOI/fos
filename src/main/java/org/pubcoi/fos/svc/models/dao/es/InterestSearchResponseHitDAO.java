...
public class InterestSearchResponseHitDAO {
    ...
    public InterestSearchResponseHitDAO(MemberInterest interest) {
    ...
    public InterestSearchResponseHitDAO setFragments(List<String> fragments) {
